...
- nva 번들에 담기는 캐릭터 클립 = 각 제작자 자산(manifest `meta.owner`). TTS 레퍼런스 음성은 NVA 밖의 독립 런타임 설정이다. IP 경계 = `.agents/progress/talkingkiosk-pulse9-ip-meeting-2026-06-21.md`(alpha-adk).
